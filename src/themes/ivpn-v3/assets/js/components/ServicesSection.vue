        ...
        <div class="services-footer">
            ...
            <span v-else>
                ...
                <label>
                    ...
                    <a :href="language + '/unlinked-access'">{{ $t('account.additionalServicesFooter2Link') }}</a>
            ...
            return [
                {
                    ...
                    syncUrl: () => {
                        ...
                        return `${this.mailXURL}/account/profile?sessionid=${sid}&subid=${uuid}`;
                    },
                ...
                },
                {
                    ...
                    syncUrl: () => {
                        ...
                        return `${this.modDNSURL}/account-preferences?sessionid=${sid}&subid=${uuid}`;
                    },
                    upgradeRequired: ['IVPN Tier 1']
                },
                {
                    ...
                    syncUrl: () => {
                        ...
                        return `${this.portmasterURL}/account?sessionid=${sid}&subid=${uuid}`;
                    },
