<template>
    <div>
            ...
            <div class="billing-options">
                <div class="plan-details" v-if="account.is_new">
                    ...
                    <div class="plan-change">
                        <router-link :to="{name: 'prices'}">Change product</router-link>
                    </div>
                </div>

                <select-billing-cycle :options="account.product.prices" v-model="price"></select-billing-cycle>
            </div>
            <div class="gap"></div>
        </div>
        <div class="pay-buttons">
            ...
            >
                <div class="credit-card-icon"></div>Credit Card
            </router-link>
            <router-link
                tag="button"
                class="btn btn-solid pay-button"
            ...
            >
                <div class="paypal-icon"></div>PayPal
            </router-link>
            <router-link
                tag="button"
                class="btn btn-solid pay-button"
            ...
            >
                <div class="bitcoin-icon"></div>Bitcoin
            </router-link>
            <router-link
                tag="button"
                class="btn btn-solid pay-button"
