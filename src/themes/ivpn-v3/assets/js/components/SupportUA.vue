<template>
    <div>
        ...
        <div v-if="lang == 'ua'">
            <p>Надсилаючи цю форму, ви погоджуєтеся з тим, що ваша IP-адреса може бути збережена, щоб допомогти нам уникнути зловживань. IP-адреси, збережені таким чином, не використовуються для будь-яких інших цілей. Решта сайту IVPN регулюється нашою загальною <a href="/privacy/">політикою конфіденційності.</a></p>
