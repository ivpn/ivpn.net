...
export default {
    ...
    actions: {
        ...
        async createLightInvoice(context, { priceID, exitServer, entryServer, publicKey, address }) {
            context.commit('started')
            try {
                let resp= await Api.createLightInvoice(priceID, exitServer, entryServer, publicKey, address)
