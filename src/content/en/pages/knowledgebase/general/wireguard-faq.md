...
10. #### How do I verify that I am connected?
    Our website shows a connection status at the top of the page or inside the 'Menu' on mobile devices. There is a green 'Connected' or a red 'Disconnected' dot, which indicates your status. Another way to ensure you are properly connected to IVPN is to simply visit the [DNS leak test](https://www.dnsleaktest.com/) website. As long as the revealed location matches the selected IVPN server and the IP address is different from the one provided by your ISP, you can reasonably assume that your traffic is routed through the VPN service.
