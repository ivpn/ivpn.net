...
sections:
    ...
    usps:
      ...
      - name: Open-source apps and website
        description: This website and the IVPN app for all platforms are
          [open-source](https://github.com/ivpn) for additional transparency and security.
      ...
      - name: Independent security audits
        description: We commit to [annual security audits](/en/blog/tags/audit/) to improve our security
          practices. Eight audits since 2019.
      - name: No virtual servers
        description: We operate [VPN gateways](/en/status/) in 41 countries on dedicated bare-metal servers. No shared VPS, no virtual locations.
      ...
      - name: Operating since 2009
        description: IVPN has run continuously under the same ownership since 2009. Review [the team](/en/team/) operating IVPN.
      - name: Business transparency
        description: Our business model is exclusively based on paid subscriptions. We never pay for reviews and closed our [affiliate program](/en/ethics/), so you won’t find us on 'top 10 best VPN' lists.
  - type: heading_text_one_column
    content: "## IVPN Features"
  - type: features_image_three_column
    ...
    features_col_one:
      ...
      - description: "**Quantum-resistant WireGuard** by default in the IVPN apps, using a post-quantum key exchange."
      ...
      - description: "**Split tunneling** to route selected apps outside the VPN (Windows, Linux and Android)."
    features_col_two:
      - description: "**Multi-hop VPN routes**. Connect through multiple servers in separate jurisdictions for enhanced privacy."
      - description: "**Killswitch / Firewall** option on macOS, Windows, Linux and Android. Offers protection against DNS, IPv6 and disconnection leaks."
      ...
      - description: "**V2Ray obfuscation** (VMess over QUIC or TCP) on every platform, plus obfs4 for OpenVPN on desktop, to connect from networks that block VPNs."
  - type: heading_text_one_column
