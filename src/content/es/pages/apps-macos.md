...
h1: IVPN para macOS
subtitle: Compatible con macOS 12+
url: /es/apps-macos/
platform: macos
layout: apps
...
releases: [{
    ...
    downloads: [
        {
            cta: Intel,
            url: "https://repo.ivpn.net/macos/bin/IVPN-3.15.15.dmg"
        },
        {
            cta: Apple Silicon,
            url: https://repo.ivpn.net/macos/bin/IVPN-3.15.15-arm64.dmg
        }
    ],
    ...
    checksum: [
        {
            title: SHA256 Intel,
            value: 6692fac6196a8c7b801a9a05a9d6324e52701bf5c52a2d8eda024ad82b9551bf
        },
        {
            title: SHA256 Apple Silicon,
            value: 8212b21653c665faef41f2234ed535bf3e29c678d9cee768c8f26bd0c1f7b438
        }
    ]
}]
---
...
Download IVPN Client para macOS (Intel) [IVPN-3.15.6.dmg](https://repo.ivpn.net/macos/bin/IVPN-3.15.6.dmg) para macOS 10.15  
SHA256: f192af338b79ffb79eb108724ef175639d966c46f9c7b4a1cf19e431372631ae  

Download IVPN Client para macOS (M1) [IVPN-3.15.6-arm64.dmg](https://repo.ivpn.net/macos/bin/IVPN-3.15.6-arm64.dmg) para macOS 10.15  
